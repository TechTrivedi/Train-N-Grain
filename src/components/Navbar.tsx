    ...
    <nav className="sticky top-0 z-40 w-full glass-panel border-b border-white/10 px-4 lg:px-8 py-3 transition-all duration-300">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <button
          ...
          className="md:hidden p-2 rounded-xl bg-white/5 border border-white/10 text-gray-200 hover:text-[#00A3FF]"
        >
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl text-left text-sm font-medium transition-all ${
                      isActive ? 'bg-[#00A3FF] text-black font-semibold' : 'text-gray-300 hover:bg-white/5'
                    }`}
                  >
              ...
              <div className="pt-2 border-t border-white/10 mt-1">
                {user ? (
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#00A3FF] text-black font-bold text-sm"
                  >
                    <LogIn className="w-4 h-4" />
