  ...
  return (
    <nav className="sticky top-0 z-40 w-full glass-panel border-b border-white/10 px-4 lg:px-8 py-3 transition-all duration-300">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-neon-dim border border-[#00F0FF]/30 flex items-center justify-center text-[#00F0FF] shadow-[0_0_15px_rgba(0, 240, 255,0.2)] group-hover:scale-105 transition-transform duration-300">
            <Flame className="w-6 h-6 animate-pulse" />
          </div>
          <div>
            <span className="font-display text-xl font-bold tracking-tight text-white group-hover:text-[#00F0FF] transition-colors">
              ...
              >
                {isActive && (
                  <motion.div
                    ...
                    className="absolute inset-0 bg-[#00F0FF] rounded-xl shadow-[0_0_20px_rgba(0, 240, 255,0.4)]"
          ...
          {user ? (
            <div className="flex items-center gap-3">
              <button
                ...
                className="flex items-center gap-2.5 px-3 py-1.5 rounded-xl bg-white/[0.04] border border-white/10 hover:border-[#00F0FF]/40 transition-colors"
              >
                <div className="w-7 h-7 rounded-full bg-[#00F0FF]/20 border border-[#00F0FF] flex items-center justify-center text-[#00F0FF] text-xs font-bold">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#00F0FF] text-black font-bold text-sm shadow-[0_0_20px_rgba(0, 240, 255,0.3)] hover:shadow-[0_0_30px_rgba(0, 240, 255,0.5)] hover:scale-[1.02] transition-all"
            >
        ...
        <button
          ...
          className="md:hidden p-2 rounded-xl bg-white/5 border border-white/10 text-gray-200 hover:text-[#00F0FF]"
        >
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-3 px-4 py-3 rounded-xl text-left text-sm font-medium transition-all ${
                      isActive ? 'bg-[#00F0FF] text-black font-semibold' : 'text-gray-300 hover:bg-white/5'
                    }`}
                  >
              ...
              <div className="pt-2 border-t border-white/10 mt-1">
                {user ? (
                  ...
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-[#00F0FF] text-black font-bold text-sm"
                  >
                    <LogIn className="w-4 h-4" />
