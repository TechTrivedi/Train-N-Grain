      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
        ...
        >
          ...
          <div className="text-center mb-6">
            <div className="inline-flex p-3 rounded-2xl bg-white/10 border border-white/20 text-[#E4E4E7] mb-3">
          ...
          <div className="flex bg-white/[0.03] p-1 rounded-2xl border border-white/10 mb-6">
            <button
              ...
              className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all ${
                !isSignUp ? 'bg-[#E4E4E7] text-black shadow-md' : 'text-gray-400 hover:text-white'
              }`}
            >
              Sign In
            </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-white/[0.04] border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-white/30 text-sm"
                  />
                </div>
              </div>
            )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-3 rounded-xl bg-white/[0.04] border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-white/30 text-sm"
                />
                <button
                  type="button"
            ...
            {!isSignUp && (
              <div className="flex justify-end">
                <button
                  ...
                  className="text-xs text-[#E4E4E7] hover:underline font-semibold"
                >
                  Forgot Password?
                </button>
              </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl bg-[#E4E4E7] text-black font-extrabold text-sm shadow-[0_0_20px_rgba(228,228,231,0.25)] hover:scale-[1.01] transition-all disabled:opacity-50"
            >
