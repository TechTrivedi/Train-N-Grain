      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md">
        ...
        >
          ...
          <div className="text-center mb-6">
            <div className="inline-flex p-3 rounded-2xl bg-[#39FF14]/10 border border-[#39FF14]/30 text-[#39FF14] mb-3">
          ...
          <div className="flex bg-white/[0.03] p-1 rounded-2xl border border-white/10 mb-6">
            <button
              ...
              className={`flex-1 py-2 rounded-xl text-xs font-semibold transition-all ${
                !isSignUp ? 'bg-[#39FF14] text-black shadow-[0_0_15px_rgba(57,255,20,0.3)]' : 'text-gray-400 hover:text-white'
              }`}
            >
              Sign In
            </button>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 rounded-xl bg-white/[0.04] border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-[#39FF14] focus:ring-1 focus:ring-[#39FF14] text-sm"
                  />
                </div>
              </div>
            )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-3 rounded-xl bg-white/[0.04] border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-[#39FF14] focus:ring-1 focus:ring-[#39FF14] text-sm"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 rounded-xl bg-[#39FF14] text-black font-bold text-sm shadow-[0_0_20px_rgba(57,255,20,0.3)] hover:shadow-[0_0_30px_rgba(57,255,20,0.5)] hover:scale-[1.01] transition-all disabled:opacity-50"
            >
