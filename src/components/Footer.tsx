      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
        ...
        <div className="md:col-span-2 space-y-4">
          <div className="flex items-center gap-2.5">
            ...
            <span className="font-consistency text-xl font-extrabold tracking-wider text-white uppercase">
          ...
          <div className="flex items-center gap-3 pt-2">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-white/10 text-[#E4E4E7] border border-white/20">
              <Sparkles className="w-3.5 h-3.5" /> Gemini 3.1 Flash Lite Engine
            </span>
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-white/10 text-gray-300 border border-white/20">
        ...
        <div>
          ...
          <ul className="space-y-2.5 text-sm text-gray-400">
            <li>
              <button onClick={() => setActiveTab('home')} className="hover:text-[#E4E4E7] transition-colors">
                Home Dashboard
              </button>
            </li>
            <li>
              <button onClick={() => setActiveTab('fitness')} className="hover:text-[#E4E4E7] transition-colors">
                AI Workout Generator
              </button>
            </li>
            <li>
              <button onClick={() => setActiveTab('nutrition')} className="hover:text-[#E4E4E7] transition-colors">
                AI Nutrition & Diet Generator
              </button>
            </li>
            <li>
              <button onClick={() => setActiveTab('profile')} className="hover:text-[#E4E4E7] transition-colors">
