      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 glass-panel rounded-3xl p-6 sm:p-8 border border-white/10 space-y-6">
          <h3 className="text-xl font-bold text-white flex items-center gap-2">
            <Zap className="w-5 h-5 text-[#39FF14]" /> Assessment Stats
          </h3>
          ...
          <form onSubmit={handleGenerate} className="space-y-4">
            ...
            <div className="pt-2 border-t border-white/10 space-y-3">
              <label className="block text-xs font-bold text-[#39FF14] uppercase tracking-wider">
              ...
              <label className="flex items-center gap-2.5 text-xs text-gray-300 cursor-pointer">
                <input
                  ...
                  className="rounded bg-white/10 border-white/20 text-[#39FF14] focus:ring-0 w-4 h-4 accent-[#39FF14]"
                />
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-4 py-2 rounded-xl bg-[#121216] border border-white/10 text-white text-xs focus:outline-none focus:border-[#39FF14]"
                >
            ...
            <div className="space-y-6">
              ...
              <div className="glass-panel rounded-2xl p-4 border border-white/10 flex flex-wrap items-center justify-between gap-4">
                <div>
                  ...
                  <span className="text-sm font-bold text-[#39FF14]">{currentStats?.goal}</span>
                  ...
                  >
                    ...
                    <div className="space-y-3">
                      {dayObj.exercises.map((ex, exIdx) => (
                        <div
                          key={exIdx}
                          className="glass-card p-4 rounded-2xl border border-white/5 space-y-1.5 hover:border-[#39FF14]/30 transition-colors"
                        >
                          <div className="flex items-center justify-between flex-wrap gap-2">
                            <span className="font-bold text-white text-sm">{ex.name}</span>
                            <span className="text-xs font-semibold text-[#39FF14] px-2.5 py-1 rounded-full bg-[#39FF14]/10 border border-[#39FF14]/20">
