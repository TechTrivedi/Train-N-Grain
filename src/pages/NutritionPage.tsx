            ...
            <div className="flex gap-1">
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${
                  dietType === 'veg' ? 'bg-[#FF5C00] text-black shadow-[0_0_15px_rgba(255, 92, 0,0.3)]' : 'text-gray-400 hover:text-white'
                }`}
              >
                🥦 Veg
              </button>
              <button
                ...
                className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-all ${
                  dietType === 'nonveg' ? 'bg-[#FF5C00] text-black shadow-[0_0_15px_rgba(255, 92, 0,0.3)]' : 'text-gray-400 hover:text-white'
                }`}
              >
                🍗 Non-Veg
              </button>
            ...
            <div className="space-y-6">
              ...
              <div className="glass-panel rounded-2xl p-4 border border-white/10 flex flex-wrap items-center justify-between gap-4">
                <div>
                  ...
                  <span className="text-sm font-bold text-[#FF5C00]">{currentPlan.goal || goal}</span>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="glass-panel p-4 rounded-2xl text-center border border-[#FF5C00]/30 bg-[#FF5C00]/5">
                  <div className="text-2xl font-black text-[#FF5C00]">{currentPlan.calories}</div>
              ...
              <div className="space-y-4">
                <h3 className="text-base font-bold text-white flex items-center gap-2">
                  <Utensils className="w-4 h-4 text-[#FF5C00]" /> Daily Meal Breakdown
                </h3>
                ...
                {currentPlan.meals && currentPlan.meals.map((m, idx) => (
                  <motion.div
                    ...
                    className="glass-panel rounded-2xl p-5 border border-white/10 space-y-2 hover:border-[#FF5C00]/30 transition-colors"
                  >
                    <div className="flex items-center justify-between flex-wrap gap-2">
                      <span className="text-sm font-bold text-white">{m.type}</span>
                      <span className="text-xs font-bold text-[#FF5C00] px-2.5 py-1 rounded-full bg-[#FF5C00]/10 border border-[#FF5C00]/20">
                        {m.calories} kcal
                      </span>
                    </div>
