/* ============================================================
   Train N Grain — Workout Database
   Single source of truth for all workout plans.
   Loaded on: index.html, fitness.html
   Exposes: window.workoutDatabase
   ============================================================ */
...
(function () {
    ...
    // Expose globally
    window.workoutDatabase = workoutDatabase;
